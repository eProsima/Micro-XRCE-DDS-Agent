...
void Root::set_verbose_level(uint8_t verbose_level)
{
    ...
    switch (verbose_level)
    {
        case 0:
            ...
            UXR_AGENT_LOG_WARN(
                "verbose_level: {}",
                UXR_DECORATE_YELLOW("logger off"), 0);
            break;
        case 1:
            spdlog::set_level(spdlog::level::critical);
            UXR_AGENT_LOG_INFO(
                "verbose_level: {}",
                UXR_DECORATE_GREEN("logger setup"), 1);
            break;
        case 2:
            spdlog::set_level(spdlog::level::err);
            UXR_AGENT_LOG_INFO(
                "verbose_level: {}",
                UXR_DECORATE_GREEN("logger setup"), 2);
            break;
        case 3:
            spdlog::set_level(spdlog::level::warn);
            UXR_AGENT_LOG_INFO(
                "verbose_level: {}",
                UXR_DECORATE_GREEN("logger setup"), 3);
            break;
        case 4:
            spdlog::set_level(spdlog::level::info);
            UXR_AGENT_LOG_INFO(
                "verbose_level: {}",
                UXR_DECORATE_GREEN("logger setup"), 4);
            break;
        case 5:
            spdlog::set_level(spdlog::level::debug);
            UXR_AGENT_LOG_INFO(
                "verbose_level: {}",
                UXR_DECORATE_GREEN("logger setup"), 5);
            break;
        case 6:
            spdlog::set_level(spdlog::level::trace);
            UXR_AGENT_LOG_INFO(
                "verbose_level: {}",
                UXR_DECORATE_GREEN("logger setup"), 6);
            break;
        default:
            UXR_AGENT_LOG_WARN(
                "verbose_level: {}",
                UXR_DECORATE_YELLOW("out-of-range level"), 0);
            break;
    }
#endif
}
