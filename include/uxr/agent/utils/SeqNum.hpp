...
public:
    ...
    friend bool operator ==(
            ...
            int rhs)
    {
        return lhs.seq_num_ == uint16_t(rhs);
    }
    ...
    friend bool operator ==(
            ...
            SeqNum rhs)
    {
        return uint16_t(lhs) == rhs.seq_num_;
    }
