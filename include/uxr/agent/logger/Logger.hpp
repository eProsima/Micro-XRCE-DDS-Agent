...
#define UXR_PARTICIPANT_ID_FORMAT   UXR_OBJECT_ID_FORMAT
#define UXR_TOPIC_ID_FORMAT         UXR_OBJECT_ID_FORMAT
#define UXR_PUBLISHER_ID_FORMAT     UXR_OBJECT_ID_FORMAT
#define UXR_SUBSCRIBER_ID_FORMAT    UXR_OBJECT_ID_FORMAT
#define UXR_DATAWRITER_ID_FORMAT    UXR_OBJECT_ID_FORMAT
#define UXR_DATAREADER_ID_FORMAT    UXR_OBJECT_ID_FORMAT
