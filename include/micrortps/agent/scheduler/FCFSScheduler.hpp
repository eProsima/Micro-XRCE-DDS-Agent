...
#ifndef _MICRORTPS_AGENT_SCHEDULER_FCFS_SCHEDULER_HPP_
#define _MICRORTPS_AGENT_SCHEDULER_FCFS_SCHEDULER_HPP_

#include <micrortps/agent/scheduler/Scheduler.hpp>
#include <queue>
#include <mutex>
...
template<class T>
inline void FCFSScheduler<T>::pop(T& element)
{
    bool rv = false;
    std::lock_guard<std::mutex> lock(mtx_);
...
#endif //_MICRORTPS_AGENT_SCHEDULER_FCFS_SCHEDULER_HPP_
